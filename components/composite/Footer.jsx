...
//   return (
//     <div className='container w-screen px-5 mt-7'>
//       <footer className='py-5 w-full'>
//         <div className='flex w-full flex-row justify-between'>
//           {Object.keys(footerLinks).map((key, index) => (
//             <div className='border-t border-2 pt-2 w-full mr-5' key={index}>
...
//         <div className='flex flex-column flex-sm-row justify-between pt-4 mt-4 border-t text-light'>
